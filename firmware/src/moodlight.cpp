...
// mapSentimentToLED, handleSentiment, formatString -> verschoben nach sensor_manager.cpp
...
// MQTT/HA-Callbacks, setupHA, sendInitialStates, sendHeartbeat, checkAndReconnectMQTT
// -> verschoben nach mqtt_handler.cpp
